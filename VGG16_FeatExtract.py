...
def VGG_16_model():
    ...
    #Transfer learning
    VGG_16_model = applications.VGG16(weights='imagenet',
                                     include_top=False,
...
plt.title('VGG16: Log Loss (Cross entropy)', fontsize= 20)
...
plt.suptitle('VGG16', fontsize = 22)
