...
def InceptionV3_model():
    ...
    # Transfer learning
    InceptionV3_model = applications.inception_v3.InceptionV3(weights='imagenet',
                                           include_top=False,
    ...
    last = InceptionV3_model.layers[-1].output
    x = Flatten()(last)
...
plt.title('InceptionV3: Log Loss (Cross entropy)', fontsize= 20)
...
plt.suptitle('InceptionV3', fontsize = 22)
