...
from sklearn.metrics import precision_recall_curve, average_precision_score, plot_precision_recall_curve, confusion_matrix
...
test_path = "D:\\plankton_cultures\\Test(Directory)"
...
######################### Model #################################
# Needs to be instantiated for this model type, instead of just standardized pixel values between 0-1
...
def ResNet50V2_model():
    ...
    # Transfer learning
    ResNet50V2_model = applications.resnet_v2.ResNet50V2(weights='imagenet',
                                           include_top=False,
    ...
    last = ResNet50V2_model.layers[-1].output
    x = Flatten()(last)
...
###################### Visually evaluating cross validation behaviour ######################
...
plt.title('ResNet50V2: Log Loss (Cross entropy)', fontsize = 20)
...
plt.suptitle('ResNet50V2', fontsize = 22)
...
plt.title('ResNet50V2', fontsize= 20)
